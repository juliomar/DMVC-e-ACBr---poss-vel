...
uses
  ...
  BPeController in 'Controller\BPeController.pas',
  uBPeWebModule in 'uBPeWebModule.pas' {BPeWebModule: TWebModule},
  Provider.BPe in 'Provider\Provider.BPe.pas' {ProviderBPe: TDataModule},
  Model.BPeMeu in 'Model\Model.BPeMeu.pas';
