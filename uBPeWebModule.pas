...
type
  TBPeWebModule = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TBPeWebModule;
...
procedure TBPeWebModule.WebModuleCreate(Sender: TObject);
begin
  ...
  FMVC.AddController(TBPeController);
...
procedure TBPeWebModule.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
